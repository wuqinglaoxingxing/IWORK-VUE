<template>
    <div class="hello">
        ...
        <!-- 日历 -->
        <h1>{{ date }}</h1>
        <IworkCalendar :isInitNow="isInitNow" iworkData="date" :format="format" :level="level" :showStyle="showStyle"
            :dateBetWeenCall="dateBetWeenCall"></IworkCalendar>
        <!-- 上传 -->
        <!-- <IworkUpload
      file="file"
    ...
    ></IworkPictureMagnifier> -->
        <!-- 抽奖转盘 -->
        <!-- <IworkLuckDraw
      :luckDrawSize="luckDrawSize"
      :selectorParts="selectorParts"
      :isBlackCurtain="isBlackCurtain"
      :setRegion="setRegion"
